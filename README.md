...
|-----------------------------------------------------------------|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [asdf-manager](skills/asdf-manager)                             | `1.1.0` | Manage project runtime dependencies, tool versions, and plugins using asdf-vm. Translates requests like "update all tools" into precise asdf commands and implements strict security checks for custom plugins not in the official community index.                                                                                                                                                                                                                              |
...
| [keep-a-changelog](skills/keep-a-changelog)                     | `2.1.0` | Manages the project's CHANGELOG.md following Keep a Changelog format. Bootstraps a new changelog from scratch, creates entries for new releases, or updates an in-progress (unreleased) entry in-place — all based on git history and tags.                                                                                                                                                                                                                                      |
