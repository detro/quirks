...
| [ground-rules](skills/ground-rules) | `1.3.0` | Helps setup, view, and edit a global context or "ground rules" file for your AI agents (such as Crush, Claude Code, or Cursor), including configuring custom global context file paths and auto-detecting the executing agent. |
